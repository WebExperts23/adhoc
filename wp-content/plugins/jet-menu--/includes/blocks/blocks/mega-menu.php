...
class Mega_Menu extends Base {
	...
	public function add_style_manager_options() {
		...
		$this->controls_manager->add_control( [
			...
			'css_selector' => array(
				'{{WRAPPER}} .jet-mega-menu-sub-menu__list, {{WRAPPER}} .jet-mega-menu-mega-container__inner' => 'border-style: {{STYLE}}; border-width: {{WIDTH}}; border-radius: {{RADIUS}}; border-color: {{COLOR}};',
			),
		] );
